       ...
       <div class="col-md-12">
         <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Edite Products</h3>
              </div>


              <form class="form-horizontal" action="{{ route('admin-updateproduct',$product->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="card-footer">
                  <button type="submit" class="btn btn-info btn-block"> <i class="fab fa-telegram-plane"></i> Update Product</button>
                </div>
                <!-- /.card-footer -->
              </form>
