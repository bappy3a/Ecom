...
@section('js')
  ...
  <script type="text/javascript">
    ...
    function publishProduct(id) {
        swal({
            title: 'Are you sure?',
            text: "You won't be sure publish This PRODUCT!",
            type: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#3085d6',
            cancelButtonColor: '#d33',
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        @if($product->publication_status == 0)
                          <button class="btn btn-success btn-sm" onclick="publishProduct({{ $product->id }})">Unpublish</button>

                          <form id="publish-form-{{ $product->id }}" action="{{ route('admin-publish-product',$product->id) }}" method="POST" style="display: none;">
                           @csrf
                        </form>
                        @else
                          <button class="btn btn-warning btn-sm" onclick="unpublisProduct({{ $product->id }})">Publish</button>

                          <form id="unpublish-form-{{ $product->id }}" action="{{ route('admin-unpublish-product',$product->id) }}" method="POST" style="display: none;">
                           @csrf
                          </form>
                        ...
                        <a class="btn btn-primary btn-sm" href="{{ route('admin-edite-product',$product->id) }}"><i class="fas fa-edit"></i></a>
