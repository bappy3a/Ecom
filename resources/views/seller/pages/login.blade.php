...
<title>Seller | Tomal | Login</title>
</head>
<body>
...
<div class="mrgn-b-lg">
    ...
    @if(Session::has('msg'))
        <h5 id="msg" class="text-center text-danger alert-heading">{{session::get('msg')}}</h5>
    @endif
    <script>
        setTimeout(function() {
            $('#msg').fadeOut('fast');
...
<div class="mrgn-b-md">
<h2 class="text-capitalize base-dark font-2x fw-normal">Seller Login</h2> </div>
